...
function Footer() {
  ...
  return (
    <Paper className={viewMode === "dark" ? classes.rootPaper : ""}>
      <AppBar
        position='static'
        color={viewMode === "light" ? "primary" : "inherit"}
        className={classes.root}>
        <div className={classes.rootDiv}>
          <div className={classes.firstDiv}>
            <h2>Farmer Facilitator System</h2>
            <p>
              This website is for online selling and puchasing agriculture
              products. You can post your AD with-in no time.
            </p>
            ...
            <div style={{ display: "flex", margin: "1%" }}>
              <ContactMailIcon />
              <p style={{ marginLeft: "2%" }}>nabeelshiex@gmail.com</p>
            </div>
          </div>
          <div className={classes.firstDiv}>
            <h2>Quick Links</h2>
          ...
          <div className={classes.firstDiv}>
            ...
            <div style={{ display: "flex" }}>
              <Avatar src={`${API_URL}/images/team/nabeel.jpeg`} />
            ...
            <a
              href='https://www.facebook.com/nabeelshiex/'
              style={{ color: "white" }}>
