...
export const GET_LOGGED_IN_USER_ID_FOR_MESSAGES = 'GET_LOGGED_IN_USER_ID_FOR_MESSAGES';
...
export const PASSWORD_UPDATED_HIDE_SNAKE_BAR = 'PASSWORD_UPDATED_HIDE_SNAKE_BAR';
...
export function getLoggedInUser() {
    ...
    const request = axios.get(`http://127.0.0.1:8000/api/auth/user/get-user?token=${token}`);
...
export function logout() {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/logout?token=${token}`);
...
export function uploadImage(image) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/user/upload-image?token=${token}`, formData);
...
export function uploadLocation(location) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/user/upload-location?token=${token}`, location);
...
export function uploadDescription(description) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/user/upload-description?token=${token}`, description);
...
export function updatePassword(data) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/user/update-password?token=${token}`, data);
    return dispatch => {
        request.then(res => {
            dispatch({
...
export function getImageForNavBar() {
    ...
    const request = axios.get(`http://127.0.0.1:8000/api/auth/user/get-image?token=${token}`);
    return dispatch => {
        request.then(res => {
            dispatch({
...
export function getRecentPosts() {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/post/recent?token=${token}`);
...
export function getAllUserPosts() {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/post/user-all?token=${token}`);
...
export function getSinglePost(postId) {
    let token = localStorage.getItem('token');
    const request = axios.post(`http://127.0.0.1:8000/api/auth/post/single?token=${token}`, { postId });
...
export function addPost(image, title, description) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/post/add?token=${token}&title=${title}&description=${description}`, formData);
...
export function allPosts() {
    ...
    const request = axios.get(`http://127.0.0.1:8000/api/auth/post?token=${token}`);
...
export function getUserForPosts(userId) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/post/get-username?token=${token}`, { userId });
...
export function getLoggedInUserWithUserId(userId) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/post/get-user?token=${token}`, { userId });
...
export function getRecentPosts2(userId) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/post/recent?token=${token}`, { userId });
...
export function getAllUserPosts2(userId) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/post/user-all?token=${token}`, { userId });
...
export function getCountOfAllPosts() {
    ...
    const request = axios.get(`http://127.0.0.1:8000/api/auth/post/count?token=${token}`);
...
export function getUsersListForMessages() {
    ...
    const request = axios.get(`http://127.0.0.1:8000/api/auth/message/get-users?token=${token}`);
...
export function getMessagesByUser(userId) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/message/get-messages?token=${token}`, { userId });
...
export function getLoggedInUserId() {
    ...
    const request = axios.get(`http://127.0.0.1:8000/api/auth/message/get-logged-in-user-id?token=${token}`);
...
export function addMessage(userId, message) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/message/add?token=${token}`, { userId, message });
...
export function getUnReadMessageCount() {
    ...
    const request = axios.get(`http://127.0.0.1:8000/api/auth/message/unread-count?token=${token}`);
...
export function getReadMessageCount(userId) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/message/read-count?token=${token}`, { userId });
...
export function addBid(formData) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/bid/add?token=${token}`, formData);
...
export function bidAccepted(bidId) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/bid/accepted?token=${token}`, { bidId });
...
export function getBrainTreeClientToken() {
    ...
    const request = axios.get(`http://127.0.0.1:8000/api/auth/payment?token=${token}`);
...
export function brainTreeCheckout(data) {
    ...
    const request = axios.post(`http://127.0.0.1:8000/api/auth/payment/checkout?token=${token}`, data);
...
export function getLineChartEarning() {
    ...
    const request = axios.get(`http://127.0.0.1:8000/api/auth/earning/total?token=${token}`);
...
export function getPieChartEarning() {
    ...
    const request = axios.get(`http://127.0.0.1:8000/api/auth/earning/pending?token=${token}`);
...
export function getBarChartEarning() {
    ...
    const request = axios.get(`http://127.0.0.1:8000/api/auth/earning/withdraw?token=${token}`);
...
export function getNumericEarning() {
    ...
    const request = axios.get(`http://127.0.0.1:8000/api/auth/earning?token=${token}`);
